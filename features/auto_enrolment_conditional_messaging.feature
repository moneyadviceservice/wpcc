Feature: Conditional messaging for users earning £5876 - £10,000 (inclusive)
  ...
  Scenario Outline: salary earning is between £5,876 and £10,000
    ...
    Examples:
      ...
      | en       | Female    | per Year         | 6000   | Your employer will not automatically enrol you into a workplace pension scheme but you can choose to join. If you do so, your employer will make contributions. |
      | cy       | Benywaidd | y Flwyddyn       | 6000   | Ni fydd eich cyflogwr yn eich cofrestru yn awtomatig am gynllun pensiwn gweithle, ond gallwch ddewis ymuno. Os felly, bydd eich cyflogwr yn gwneud cyfraniadau. |
  ...
  Scenario Outline: salary earning is above the upper threshold of £10,000
    ...
    Examples:
      | language | gender    | salary_frequency | salary  | conditional_message                                                                                                                                             |
      | en       | Female    | per Year         | 10001   | Your employer will not automatically enrol you into a workplace pension scheme but you can choose to join. If you do so, your employer will make contributions. |
      | cy       | Benywaidd | y Flwyddyn       | 10001   | Ni fydd eich cyflogwr yn eich cofrestru yn awtomatig am gynllun pensiwn gweithle, ond gallwch ddewis ymuno. Os felly, bydd eich cyflogwr yn gwneud cyfraniadau. |
  ...
  Scenario Outline: salary earning is below the lower threshold of £5,876
    ...
    Examples:
      | language | gender    | salary_frequency | salary | conditional_message                                                                                                                                             |
      | en       | Female    | per Year         | 5875   | Your employer will not automatically enrol you into a workplace pension scheme but you can choose to join. If you do so, your employer will make contributions. |
      | cy       | Benywaidd | y Flwyddyn       | 5875   | Ni fydd eich cyflogwr yn eich cofrestru yn awtomatig am gynllun pensiwn gweithle, ond gallwch ddewis ymuno. Os felly, bydd eich cyflogwr yn gwneud cyfraniadau. |
