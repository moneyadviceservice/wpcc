Feature: Conditional messaging for users earning £5876 - £10,000 (inclusive)
  ...
  Scenario Outline: salary earning is between £5,876 and £10,000
    ...
    And   I should see the auto-enrolment "<conditional_message>"
    And   I should see the information in my own "<language>"

    Examples:
      | language | salary | conditional_message |
      | English  | 6000   | Your employer will not automatically enrol you into a workplace pension scheme but you can choose to join. If you do so, your employer will make contributions.|
      | Welsh    | 6000   | Ni fydd eich cyflogwr yn eich cofrestru yn awtomatig am gynllun pensiwn gweithle, ond gallwch ddewis ymuno. Os felly, bydd eich cyflogwr yn gwneud cyfraniadau. |
