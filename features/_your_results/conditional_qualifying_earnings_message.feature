Feature: Additional message depending on your contribution preference
  ...
  Background:
    ...
    Scenario Outline: When is Minimum contribution
      ...
      Examples:
        | message |
        | Contributions will be based on your qualifying earnings i show help of £28,864 per year |

      @welsh
      Examples:
        | message |
        | Bydd cyfraniadau yn seiliedig ar eich enillion cymwys i sioe help o £28,864 y flwyddyn. |
